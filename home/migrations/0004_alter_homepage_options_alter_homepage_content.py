# Generated by Django 5.0.14 on 2025-10-27 05:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("home", "0003_alter_homepage_options_homepage_about_description_and_more"),
    ]
                ...
                block_lookup={
                    ...
                    70: (
                        ...
                        [
                            [
                                ("theme_mode", 48),
                                ("enable_customization", 49),
                                ("primary_color", 50),
                                ("secondary_color", 51),
                                ("background_color", 52),
                                ("surface_color", 53),
                                ("text_color", 54),
                                ("text_secondary_color", 55),
                                ("border_color", 56),
                                ("font_family", 57),
                                ("font_size_scale", 58),
                                ("show_theme_switcher", 59),
                                ("switcher_position", 60),
                                ("switcher_style", 61),
                                ("enable_transitions", 62),
                                ("transition_duration", 63),
                                ("enable_persistence", 64),
                                ("enable_server_persistence", 65),
                                ("enable_auto_detect", 66),
                                ("auto_contrast_adjustment", 67),
                                ("enable_high_contrast_mode", 68),
                                ("focus_outline_style", 69),
                            ]
                        ],
                        {},
                    ),
